...
document.addEventListener('deviceready', function() {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql('CREATE TABLE IF NOT EXISTS user_profile (id integer primary key, user_id integer, biography text, contact integer, picture text, date_updated text, FOREIGN KEY(user_id) REFERENCES users(id))');
