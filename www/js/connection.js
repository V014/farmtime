...
document.addEventListener('deviceready', function() {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql('CREATE TABLE IF NOT EXISTS crop_variety (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, crop_name TEXT NOT NULL, crop_variety TEXT NOT NULL, availability TEXT NOT NULL, pH_requirement INTEGER, temperature_celsius INTEGER, rainfall_mm INTEGER, season_requirement TEXT NOT NULL, maturity_rate INTEGER, yield_estimate INTEGER, yield_unit TEXT, common_pests TEXT, treatment TEXT NOT NULL, date_recorded DATETIME NOT NULL, date_updated DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)');
