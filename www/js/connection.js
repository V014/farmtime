...
document.addEventListener('deviceready', function() {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql('CREATE TABLE IF NOT EXISTS plots (id integer primary key AUTOINCREMENT, user_id integer, crop_id integer, name text, area text, location text, soil_type text, date_created DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, date_updated DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(user_id) REFERENCES user(id), FOREIGN KEY(crop_id) REFERENCES crop(id))');
