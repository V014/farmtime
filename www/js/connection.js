...
function onDeviceReady() {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql('CREATE TABLE IF NOT EXISTS plot (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, field_id INTEGER NOT NULL, plot_name TEXT NOT NULL, area_height INTEGER NOT NULL, area_width INTEGER NOT NULL, date_recorded DATETIME NOT NULL, date_updated DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(field_id) REFERENCES field(id))');
        // 3. Crop Management Tables
        tx.executeSql('CREATE TABLE IF NOT EXISTS crop_variety (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, crop_name TEXT NOT NULL, crop_variety TEXT NOT NULL, availability TEXT NOT NULL, pH_min INTEGER, pH_max INTEGER, temp_min INTEGER, temp_max INTEGER, rainfall_min INTEGER, rainfall_max INTEGER, season_requirement TEXT NOT NULL, yield_estimate INTEGER, yield_unit TEXT, common_pests TEXT, common_diseases TEXT, soil_type TEXT NOT NULL, fertilizer_growing TEXT, growth_days INTEGER, fertilizer_production TEXT, production_days INTEGER, irrigation_needs TEXT NOT NULL, planting_distance INTEGER NOT NULL, date_recorded DATETIME NOT NULL, date_updated DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)');
        ...
        tx.executeSql('CREATE TABLE IF NOT EXISTS crop (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, plot_id INTEGER NOT NULL, crop_variety_id INTEGER NOT NULL, supplier_id INTEGER, batch_number TEXT, growth_stage TEXT NOT NULL, status TEXT NOT NULL, date_registered DATETIME NOT NULL, date_updated DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(plot_id) REFERENCES plot(id), FOREIGN KEY(crop_variety_id) REFERENCES crop_variety(id), FOREIGN KEY(supplier_id) REFERENCES supplier(id))');
