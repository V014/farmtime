$(document).ready(function() {
    ...
    const headerTemplate = `
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Farmtime</a>
            <!-- Sidebar Toggle-->
    ...
    // Define the Navigation Template
    const navTemplate = `
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseCrops" aria-expanded="false" aria-controls="collapseCrops">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-leaf"></i></div>
                    Crops
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapseCrops" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="planted_crops.html">Active crops</a>
                        <a class="nav-link" href="crop_variety.html">Crop variety</a>
                    </nav>
                </div>

                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLands" aria-expanded="false" aria-controls="collapseLands">
    ...
    // 2. The "Active" Logic
    // Get the current file name (e.g., "login.html")
    const path = window.location.pathname;
    const page = path.split("/").pop();

    // 3. Find the link that matches the current page and add the class
